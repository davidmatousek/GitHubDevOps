...
public final class FetchViewerQuery: GraphQLQuery {
  ...
  public let operationName: String = "FetchViewer"
    ...
    public struct Viewer: GraphQLSelectionSet {
      ...
      public struct Organization: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, name: String? = nil, repositories: Repository) {
            self.init(unsafeResultMap: ["__typename": "Organization", "id": id, "name": name, "repositories": repositories.resultMap])
          }
